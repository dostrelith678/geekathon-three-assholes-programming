const getPrompt = (cloneName, customPrompt) => {
    let promptName;
    if (cloneName == 'Arnold Schwarzenegger') {
        promptName = "Arnold"
        return `actual 8K realistic portrait photo of ${promptName} person ${customPrompt}, portrait, happy colors, bright eyes, clear eyes, warm smile, smooth soft skin, big dreamy eyes, symmetrical, anime wide eyes, soft lighting, detailed face, by makoto shinkai, stanley artgerm lau, wlop, rossdraws, concept art, digital painting, old age`
    } else {
        promptName = "Salma Hayek"
